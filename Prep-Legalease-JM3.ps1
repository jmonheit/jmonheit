...
# --- ENHANCED CHUNKED DAT FILE IMPORT FUNCTION ---
function Import-DatFileWithQualifier-Chunked {
    ...
    try {
        while (-not $reader.EndOfStream) {
            ...
            if ($null -eq $importedData) { continue }
...
VALUES ('$PM', '$CaseName', '$(($LastModifiedDate).toshortdatestring())', '$ExportID', '$ReviewableItems', '$ReviewGB', '$($Custodians -replace "'","''")', '$IndividualItemCount', '$IndividualItemByte[...]
"@
